...
<div class="card">
  ...
  <div class="card-body">
    ...
    @endif
    <zing-grid lang="custom" caption='Reporte de oficios' selector sort search pager page-size='10' page-size-options='1,2,3,4,5,10' layout='row' viewport-stop theme='android' id='zing-grid' filter selector data="{{$json}}">
      <zg-colgroup>
